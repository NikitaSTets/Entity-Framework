...
namespace EF1 {
    ...
    public partial class MyDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class MyTableDataTable : global::System.Data.TypedTableBase<MyTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MyTableRow AddMyTableRow(int Id, string FirstName, string LastName) {
        ...
        public partial class MyTableRow : global::System.Data.DataRow {
            ...
            public string FirstName {
                get {
                    return ((string)(this[this.tableMyTable.FirstNameColumn]));
                }
                set {
                    this[this.tableMyTable.FirstNameColumn] = value;
                }
            }
            ...
            public string LastName {
                get {
                    try {
                        return ((string)(this[this.tableMyTable.LastNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'LastName\' в таблице \'MyTable\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableMyTable.LastNameColumn] = value;
                }
            }
            ...
            public bool IsLastNameNull() {
                return this.IsNull(this.tableMyTable.LastNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetLastNameNull() {
                this[this.tableMyTable.LastNameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace EF1.MyDatabaseDataSetTableAdapters {
    ...
    public partial class MyTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MyTable] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Orig" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MyTable] ([Id], [FirstName], [LastName]) VALUES (@Id, @FirstNa" +
                "me, @LastName);\r\nSELECT Id, FirstName, LastName FROM MyTable WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MyTable] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT Id, FirstName, LastName FROM MyTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EF1.Properties.Settings.Default.MyDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName FROM dbo.MyTable";
